...
const (
	...
	ErrInvalidQuantity        = "quantity must be between 1 and 2147483647"
	ErrOrderItemTotalOverflow = "order item total exceeds int64"
	ErrOrderSubtotalOverflow  = "order subtotal exceeds int64"
	ErrReleaseStockEmpty      = "release stock returned empty response"
	ErrConfirmStockEmpty      = "confirm stock returned empty response"
	ErrConfirmStockFailed     = "confirm stock failed: %s"
	ErrReleaseStockFailed     = "release stock failed: %s"
