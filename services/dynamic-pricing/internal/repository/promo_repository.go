...
func (r *promoRepository) List(ctx context.Context, params dto.ListPromoParams) ([]domain.Promo, error) {
	const query = `
		...
		ORDER BY
		  ...
		  CASE WHEN $3::text = 'start_date' AND $4::text = 'asc'  THEN start_date END ASC,
		  ...
		  CASE WHEN $3::text = 'start_date' AND $4::text = 'desc' THEN start_date END DESC,
...
func (r *promoRepository) Create(ctx context.Context, args dto.CreatePromoDto) error {
	...
	`
	_, err := r.db.Exec(ctx, query, args.Id, args.Name, args.Code, args.Description, args.DiscountType, args.DiscountValue,
		args.MinPurchase, args.MaxDiscount, args.Quantity, args.MaxUsagePerUser, args.CanCombineFlashSale, args.StartDate, args.EndDate, args.IsActive)
	if err != nil {
		return err
	}
...
func (r *promoRepository) Update(ctx context.Context, args dto.UpdatePromoDto) error {
	...
	`
	cmdTag, err := r.db.Exec(ctx, query, args.Id, args.Name, args.Code, args.Description, args.DiscountType, args.DiscountValue,
		args.MinPurchase, args.MaxDiscount, args.Quantity, args.MaxUsagePerUser, args.CanCombineFlashSale, args.StartDate, args.EndDate, args.IsActive)
	if err != nil {
		return err
	}
