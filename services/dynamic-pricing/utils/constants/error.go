...
const (
	...
	ErrFlashSaleStockInsufficient    = "insufficient flash sale stock"
	ErrFlashSaleQuantityInvalid      = "quantity must be greater than zero"
	ErrAllocationConflict            = "order ID already belongs to a different pricing allocation request"
	ErrAllocationOwnerMismatch       = "order ID belongs to another pricing allocation"
	ErrAllocationAlreadyReleased     = "pricing allocation was released"
	ErrFlashSaleReleaseTargetMissing = "flash sale release target missing"
	ErrFlashSaleUsageTargetMissing   = "flash sale usage release target missing"
	ErrPromoReleaseTargetMissing     = "promo release target missing"
	ErrPromoUsageTargetMissing       = "promo usage release target missing"
	ErrAllocationReleaseTargetMissing = "pricing allocation release target missing"
