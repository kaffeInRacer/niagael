...
func NewProductHandler(
	...
	adminProducts.GET("", authorization.Authorize("product", "read"), h.List)
	adminProducts.POST("", authorization.Authorize("product", "create"), h.Create)
	adminProducts.GET("/slug/:slug", authorization.Authorize("product", "read"), h.ReadBySlug)
	adminProducts.GET("/:id", authorization.Authorize("product", "read"), h.ReadById)
	adminProducts.PUT("/:id", authorization.Authorize("product", "update"), h.Update)
	adminProducts.DELETE("/:id", authorization.Authorize("product", "delete"), h.Delete)
	adminProducts.GET("/:id/images", authorization.Authorize("product_image", "read"), imageHandler.ListByProductId)
	adminProducts.POST("/:id/images", authorization.Authorize("product_image", "create"), imageHandler.Create)
	adminProducts.DELETE("/:id/images/:image_id", authorization.Authorize("product_image", "delete"), imageHandler.Delete)
